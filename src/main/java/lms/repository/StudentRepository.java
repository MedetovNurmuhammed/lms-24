...
public interface StudentRepository extends JpaRepository<Student,Long> {
    ...
    @Query("select new lms.dto.response.StudentResponse(s.id,s.user.fullName,s.user.phoneNumber,s.group.title,s.studyFormat,s.user.email,s.user.block) " +
            "from Student s where s.group.id = :groupId and s.trash.id is null")
