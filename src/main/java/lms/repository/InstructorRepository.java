...
public interface InstructorRepository extends JpaRepository<Instructor, Long> {
    @Query("select distinct new lms.dto.response.InstructorsOrStudentsOfCourse(i.id, c.title, i.user.fullName, i.specialization, i.user.phoneNumber, i.user.email) from Instructor i join i.courses c where c.id = :courseId")
