...
insert into answer_tasks (id, student_id, task_answer_status, date_of_send,  task_id, text, comment, image ) values (8, 8, 'REJECTED', '2024-04-19', 8, 'nec condimentum neque sapien placerat ante nulla justo aliquam quis turpis eget elit sodales scelerisque mauris sit amet', 'morbi non quam nec dui luctus rutrum nulla tellus in sagittis dui vel', 'ut odio cras mi pede malesuada in imperdiet et commodo vulputate justo in blandit ultrices enim lorem ipsum dolor');
insert into answer_tasks (id, student_id, task_answer_status, date_of_send,  task_id, text, comment, image ) values (9, 9, 'WAITING', '2024-04-10', 9, 'tellus semper interdum mauris ullamcorper purus sit amet nulla quisque arcu', 'vel nisl duis ac nibh fusce lacus purus aliquet at feugiat non pretium quis lectus suspendisse potenti in eleifend quam', 'ut volutpat sapien arcu sed augue aliquam erat volutpat in congue etiam justo etiam pretium iaculis');
